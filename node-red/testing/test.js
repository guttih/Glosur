var ghslib = require('../data/ghslib.js');
...
function isNightTime(dateTime) {
    ...
    return ghslib.isTimeInRange(dateTime, 23, 0, 7, 55);
}
...
if (ghslib.isTimeInRange(getDateTime(msg), fromHour, fromMinute, toHour, toMinute)) {
...
console.log("-------------------Tests for ghslib.isTimeInRange function-------------------");
...
if (ghslib.isTimeInRange(getDateTime(msg), 23, 1, 7, 59)) {
    console.log("Motion detected in the bathroom \033[01;32mbetween\033[0m "+ fromStr + " and "+ toStr +".");
} else {
    console.log("Motion detected in the bathroom \033[01;31moutside\033[0m "+ fromStr + " and "+ toStr +".");
}
...
console.log("Current time: " + getDateTime(msg));
if (ghslib.isTimeInRange(getDateTime(msg), 1, 1, 7, 59)) {
    console.log("Motion detected in the bathroom \033[01;32mbetween\033[0m "+ fromStr + " and "+ toStr +".");
} else {
    console.log("Motion detected in the bathroom \033[01;31moutside\033[0m "+ fromStr + " and "+ toStr +".");
}
...
console.log("Current time: " + getDateTime(msg));
if (ghslib.isTimeInRange(getDateTime(msg), 17, 0, 7, 59, true)) {
    console.log("Motion detected in the bathroom \033[01;32mbetween\033[0m "+ fromStr + " and "+ toStr +".");
} else {
    console.log("Motion detected in the bathroom \033[01;31moutside\033[0m "+ fromStr + " and "+ toStr +".");
}
...
// Testing ../data/ghslib.js

// Test 1
// call the module.exports.hello = function() 
// require the library

console.log(ghslib.hello());